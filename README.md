...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([11.5.0](https://github.com/simple-icons/simple-icons/releases/tag/11.5.0), today) - SVG icons for popular brands
- [evroon/bracket](https://github.com/evroon/bracket) ([v1.4.2](https://github.com/evroon/bracket/releases/tag/v1.4.2), 1 day ago) - Selfhosted tournament system with web interface
