...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([11.2.0](https://github.com/simple-icons/simple-icons/releases/tag/11.2.0), today) - SVG icons for popular brands
- [tabler/tabler-icons](https://github.com/tabler/tabler-icons) ([v3.0.0-alpha.0](https://github.com/tabler/tabler-icons/releases/tag/v3.0.0-alpha.0), 3 days ago) - A set of over 4900 free MIT-licensed high-quality SVG icons for you to use in your web projects.
- [nuxt/ui](https://github.com/nuxt/ui) ([v2.12.3](https://github.com/nuxt/ui/releases/tag/v2.12.3), 3 days ago) - A UI Library for Modern Web Apps, powered by Vue &amp; TailwindCSS.
...
- [2023 - 命题作文](https://seviche.cc/2024-01-20-2023) (1 day ago)
