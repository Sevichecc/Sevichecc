...
- [tabler/tabler-icons](https://github.com/tabler/tabler-icons) ([v3.6.0](https://github.com/tabler/tabler-icons/releases/tag/v3.6.0), 2 days ago) - A set of over 5200 free MIT-licensed high-quality SVG icons for you to use in your web projects.
- [primefaces/primevue](https://github.com/primefaces/primevue) ([4.0.0-rc.1](https://github.com/primefaces/primevue/releases/tag/4.0.0-rc.1), 2 days ago) - Next Generation Vue UI Component Library
- [nuxt/ui](https://github.com/nuxt/ui) ([v2.17.0](https://github.com/nuxt/ui/releases/tag/v2.17.0), 2 days ago) - A UI Library for Modern Web Apps, powered by Vue &amp; Tailwind CSS.
