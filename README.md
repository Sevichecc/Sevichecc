...
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([11.1.0](https://github.com/simple-icons/simple-icons/releases/tag/11.1.0), 2 days ago) - SVG icons for popular brands
- [tabler/tabler-icons](https://github.com/tabler/tabler-icons) ([v2.46.0](https://github.com/tabler/tabler-icons/releases/tag/v2.46.0), 4 days ago) - A set of over 4900 free MIT-licensed high-quality SVG icons for you to use in your web projects.
