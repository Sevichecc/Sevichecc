...
- [tabler/tabler-icons](https://github.com/tabler/tabler-icons) ([v3.0.0-alpha.0](https://github.com/tabler/tabler-icons/releases/tag/v3.0.0-alpha.0), 2 days ago) - A set of over 4900 free MIT-licensed high-quality SVG icons for you to use in your web projects.
- [nuxt/ui](https://github.com/nuxt/ui) ([v2.12.3](https://github.com/nuxt/ui/releases/tag/v2.12.3), 2 days ago) - A UI Library for Modern Web Apps, powered by Vue &amp; TailwindCSS.
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([11.1.0](https://github.com/simple-icons/simple-icons/releases/tag/11.1.0), 6 days ago) - SVG icons for popular brands
