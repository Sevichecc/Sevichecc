...
- [nuxt/ui](https://github.com/nuxt/ui) ([v2.16.0](https://github.com/nuxt/ui/releases/tag/v2.16.0), 1 day ago) - A UI Library for Modern Web Apps, powered by Vue &amp; Tailwind CSS.
- [evroon/bracket](https://github.com/evroon/bracket) ([v1.4.7](https://github.com/evroon/bracket/releases/tag/v1.4.7), 4 days ago) - Selfhosted tournament system with web interface
- [primefaces/primevue](https://github.com/primefaces/primevue) ([4.0.0-beta-2](https://github.com/primefaces/primevue/releases/tag/4.0.0-beta-2), 5 days ago) - Next Generation Vue UI Component Library
