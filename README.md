...
- [primefaces/primevue](https://github.com/primefaces/primevue) ([4.0.0-beta.4](https://github.com/primefaces/primevue/releases/tag/4.0.0-beta.4), 3 days ago) - Next Generation Vue UI Component Library
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([12.0.0](https://github.com/simple-icons/simple-icons/releases/tag/12.0.0), 1 week ago) - SVG icons for popular brands
