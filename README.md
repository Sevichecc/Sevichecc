...
- [tabler/tabler-icons](https://github.com/tabler/tabler-icons) ([v3.5.0](https://github.com/tabler/tabler-icons/releases/tag/v3.5.0), 1 day ago) - A set of over 5200 free MIT-licensed high-quality SVG icons for you to use in your web projects.
- [simple-icons/simple-icons](https://github.com/simple-icons/simple-icons) ([11.15.0](https://github.com/simple-icons/simple-icons/releases/tag/11.15.0), 3 days ago) - SVG icons for popular brands
